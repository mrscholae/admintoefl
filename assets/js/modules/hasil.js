    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            if( eror == 1){
                ...
                let result = ajax(url_base+"tes/edit_peserta", "POST", data);
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            if( eror == 1){
                ...
                let result = ajax(url_base+"tes/add_sertifikat", "POST", data);
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            if( eror == 1){
                ...
                let result = ajax(url_base+"tes/edit_sertifikat", "POST", data);
