<?php
    function ssistima_tarakib($nilai){
        switch ($nilai) {
            case 0:
                $data = 20;
                break;
    ...
    <table border=1 style="border-collapse: collapse">
        <thead>
            <tr>
                ...
                <th rowspan="2" style="padding: 10px">SKOR TOAEL</th>
                <th rowspan="2" style="padding: 10px">SKOR TOAEL</th>
            </tr>
            <tr>
        ...
        <tbody>
            <?php foreach ($respon as $i => $respon) :?>
                <?php $skor = ((listening($respon['nilai_listening']) + structure($respon['nilai_structure']) + reading($respon['nilai_reading'])) * 10) / 3;?>
                <tr>
                    ...
                    <td style="padding: 10px"><center><?= listening($respon['nilai_listening'])?></center></td>
                    <td style="padding: 10px"><center><?= $respon['nilai_structure']?></center></td>
                    <td style="padding: 10px"><center><?= structure($respon['nilai_structure'])?></center></td>
                    <td style="padding: 10px"><center><?= $respon['nilai_reading']?></center></td>
                    <td style="padding: 10px"><center><?= reading($respon['nilai_reading'])?></center></td>
